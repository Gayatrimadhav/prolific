...
const Signup = () => {
  ...
  var navigate = useNavigate();
    const host="http://43.205.140.171:5008"
  ...
  <div className="mb-3">
    ...
    <input type="password" className="form-control" id="cpassword" placeholder="Enter confirm password" name="cpassword" onChange={onChange}/>
  </div>
